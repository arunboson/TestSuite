...
def getReportFile():
    ...
    filename = 'Report_' + str(loc_time.tm_mday) + '_' + str(loc_time.tm_mon) + '_' + str(loc_time.tm_year) + '_' + str(loc_time.tm_hour) + '_' + str(loc_time.tm_min) + '_' + str(loc_time.tm_sec) + '.csv'
